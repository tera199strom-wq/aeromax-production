      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div ref={triggerRef} className="grid grid-cols-1 lg:grid-cols-2 gap-12 relative">
          ...
          <div className="space-y-12">
            ...
            >
              Aeromax Production adalah perusahaan yang sudah 25 tahun berdiri dan bergerak di industri entertainment dan penyedia kebutuhan produksi profesional. Kami hadir sebagai partner terpercaya dalam mendukung berbagai jenis acara dengan konsep yang kreatif, teknis yang profesional, dan eksekusi yang terorganisir dengan baik.
            </ScrollReveal>
