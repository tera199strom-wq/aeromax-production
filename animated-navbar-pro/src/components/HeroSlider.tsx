      ...
      >
        {items.map((item) => (
          ...
          >
            ...
            <div className="slider-content relative z-10 flex flex-col justify-center h-full px-12 md:px-24 max-w-4xl">
              <h2 className="title text-white font-black uppercase text-4xl md:text-6xl mb-4 drop-shadow-lg" style={{ fontFamily: "'Arial Black', sans-serif" }}>
                {item.title}
              </h2>
              <p className="description text-white text-lg md:text-xl mb-8 drop-shadow-md leading-relaxed">
                {item.description}
              </p>
